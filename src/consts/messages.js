const MESSAGES = {
  ...
  car: (user, hold,marque,capacity,type, immatriculation) => `L'utilisateur immatriculé ${user} effectue la création du véhicule de marque ${marque} immatriculé ${immatriculation} d'une capacité de ${capacity} consommant du ${type} qui réside a la soute immatriculé ${hold}`
};
module.exports = {
  MESSAGES
};
